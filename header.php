            ...
            <div class="navbar-header">
               <a href="index.php" class="navbar-brand">
                  <div class="brand-logo">
                     <img src="app/img/logo.jpeg" alt="App Logo" class="img-responsive">
                  </div>
				  ...
				  <li class=" ">
                    <a href="#company" title="Dashboard" data-toggle="collapse">
                     ...
                     <ul id="company" class="nav sidebar-subnav collapse">
                        ...
                        <li class=" ">
                           <a href="company.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Comapany</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="employee.php" title="Projects Basic">
								<span><em class="icon-plus"></em> employee</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="kycupdate.php" title="Projects Basic">
								<span><em class="icon-plus"></em> KYC Update</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="contractor.php" title="Projects Basic">
                    ...
                    <a href="#contractor" title="Dashboard" data-toggle="collapse">
                     ...
                     <ul id="contractor" class="nav sidebar-subnav collapse">
                        ...
                        <li class=" ">
                           <a href="packing wages.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Packing Wages</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="bidirolle wages.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Bidi Rolle Wages</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="professional wages.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Professional Wages</span>
                           </a>
                        </li>
                    ...
                    <a href="#entry" title="Dashboard" data-toggle="collapse">
                     ...
                     <ul id="entry" class="nav sidebar-subnav collapse">
                        ...
                        <li class=" ">
                           <a href="officeStaff.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Office Staff</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="packers.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Packers</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="bidiRoller.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Bidi Roller </span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="challanDate.php" title="Projects Basic">
                    ...
                    <a href="#utility" title="Dashboard" data-toggle="collapse">
                     ...
                     <ul id="utility" class="nav sidebar-subnav collapse">
                        ...
                        <li class=" ">
                           <a href="calender.php" title="Projects Basic">
								<span><em class="icon-plus"></em> Calender</span>
                           </a>
                        </li>
                        <li class=" ">
                           <a href="user management.php" title="Projects Basic">
